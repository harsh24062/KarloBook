    ...
    <div className="px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden">
       ...
       <p className="text-gray-300 font-medium text-lg max-w-[960px] mx-auto">
        ...
        <div className="relative mt-6">
           ...
           className="mx-auto max-w-full" height="540px" width="960px"/>
        </div>
        <div className="group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto">
           {dummyTrailers.map((trailer,index)=>(
            <div key={index} className="relative group-hover:not-hover:opacity-50 hover:-translate-y-1 
             duration-300 transition max-md:h-60 md:max-h-60 cursor-pointer" onClick={()=>setCurrentTrailer(trailer)}>
               <img src={trailer.image} alt="trailer_logo" className="rounded-lg 
